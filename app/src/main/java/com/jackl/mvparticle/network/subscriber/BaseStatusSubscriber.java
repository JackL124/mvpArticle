 ...
 *            佛祖保佑             永无BUG
 * @Author: JackL
 * 创建时间: 2019/1/14 15:44
 * 版本:1.0.0
 * 描述: BaseStatusSubscriber
 *
*/

public class BaseStatusSubscriber<T> extends Subscriber<T> {

      private IBaseStatus mView;
      private ResponseListener<T> mSubscriberOnNextListener;

      public BaseStatusSubscriber(ResponseListener<T> listener, IBaseStatus view) {
