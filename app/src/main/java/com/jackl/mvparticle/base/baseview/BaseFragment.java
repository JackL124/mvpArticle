 ...
 *
 */
 abstract class BaseFragment extends RxFragment implements ISupportFragment {
      ...
      protected void setStatusBar() {
            StatusBarUtil.setColorForSwipeBack(_mActivity,getResources().getColor(R.color.colorPrimary) ,  0);
      }
