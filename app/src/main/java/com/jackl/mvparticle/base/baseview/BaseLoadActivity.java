 ...
 *                      `=---='
  *            佛祖保佑             永无BUG
 * @Author: JackL
 * 创建时间: 2019/2/18 15:15
 * 版本:1.0.0
 * 描述: BaseLoadActivity
 *
*/
public abstract class BaseLoadActivity <T extends IBasePresenter> extends BaseSwipeBackActivity implements IBaseLoad {
      @Inject
      ...
      protected void showLoadView(){
            if (!ld.isAdded()) {
                  ld.show(getSupportFragmentManager(),loadTag);
            }
      }
