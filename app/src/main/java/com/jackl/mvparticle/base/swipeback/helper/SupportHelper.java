package com.jackl.mvparticle.base.swipeback.helper;
...
public class SupportHelper {
      ...
      @SuppressWarnings("unchecked")
      public static <T extends ISupportFragment> T findBackStackFragment(Class<T> fragmentClass, String toFragmentTag, FragmentManager fragmentManager) {
            int count = fragmentManager.getBackStackEntryCount();
      ...
      public static List<Fragment> getWillPopFragments(FragmentManager fm, String targetTag, boolean includeTarget) {
