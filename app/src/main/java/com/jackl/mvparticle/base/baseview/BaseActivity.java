 ...
 *            佛祖保佑             永无BUG
 * @Author: JackL
 * 创建时间: 2019/1/10 15:34
 * 版本:1.0.0
 * 描述: BaseActivity
 *
 */
abstract class BaseActivity extends RxAppCompatActivity implements ISupportActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        AppTaskManager.addActivity(this);
        setStatusBar();
    }
    ...
    protected void onDestroy() {
        mDelegate.onDestroy();
        AppTaskManager.finishActivity(this);
        super.onDestroy();
    }
